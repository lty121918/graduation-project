    ...
    <div class="stock">
        ...
        <div class="stock__main">
            ...
            <div class="stock__main__info">
                ...
                <span>跌停:&nbsp;<b :class="(0.9*stockPrice[5]).toFixed(2)>stockPrice[5] ? 'redStock' : 'greenStock'">{{ (0.9*stockPrice[5]).toFixed(2) }}</b></span>
        ...
        <div class="stock__side">
            ...
            :origin-text="log.content"
          >
            <template #extra="extra">
              <div
                class="task-detail-extra"
                :style="{
                  opacity: extra?.isMore ? 1 : 0,
                }"
                @click="log.showMore = !log.showMore"
              >
                {{ !log.showMore ? "展开" : "收起" }}
              </div>
            </template> </NEllipsis
          > -->
            ...
            <div class="stock__side-item">
                ...
                <div class="stock__side__desc">{{ stockCompany[3] }}</div>
            </div>
            <div class="stock__side-item">
